...
async function callFunctionWithModifier ( contract, signer, signature, params, error = null ) {
	let numArgs = params ? Object.keys( params )?.length || 0 : 0
	switch ( numArgs ) {
		case 0:
			await callFunctionWithModifier__0( contract, signer, signature, params, error )
			break;
		case 1:
			await callFunctionWithModifier__1( contract, signer, signature, params, error )
			break;
		case 2:
			await callFunctionWithModifier__2( contract, signer, signature, params, error )
			break;
		case 3:
			await callFunctionWithModifier__3( contract, signer, signature, params, error )
			break;
		case 4:
			await callFunctionWithModifier__4( contract, signer, signature, params, error )
			break;
		case 5:
			await callFunctionWithModifier__5( contract, signer, signature, params, error )
			break;
		case 6:
			await callFunctionWithModifier__6( contract, signer, signature, params, error )
			break;
		case 7:
			await callFunctionWithModifier__7( contract, signer, signature, params, error )
			break;
		case 8:
			await callFunctionWithModifier__8( contract, signer, signature, params, error )
			break;
		case 9:
			await callFunctionWithModifier__9( contract, signer, signature, params, error )
			break;
		case 10:
			await callFunctionWithModifier__10( contract, signer, signature, params, error )
			break;
		default:
			return;
	}
...
async function callFunctionWithModifier__0 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]()
...
async function callFunctionWithModifier__1 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
...
async function callFunctionWithModifier__2 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ], params[ 1 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
...
async function callFunctionWithModifier__3 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ], params[ 1 ], params[ 2 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
...
async function callFunctionWithModifier__4 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ], params[ 1 ], params[ 2 ], params[ 3 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
...
async function callFunctionWithModifier__5 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ], params[ 1 ], params[ 2 ], params[ 3 ], params[ 4 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
...
async function callFunctionWithModifier__6 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ], params[ 1 ], params[ 2 ], params[ 3 ], params[ 4 ], params[ 5 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
...
async function callFunctionWithModifier__7 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ], params[ 1 ], params[ 2 ], params[ 3 ], params[ 4 ], params[ 5 ], params[ 6 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
...
async function callFunctionWithModifier__8 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ], params[ 1 ], params[ 2 ], params[ 3 ], params[ 4 ], params[ 5 ], params[ 6 ], params[ 7 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
...
async function callFunctionWithModifier__9 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ], params[ 1 ], params[ 2 ], params[ 3 ], params[ 4 ], params[ 5 ], params[ 6 ], params[ 7 ], params[ 8 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
...
async function callFunctionWithModifier__10 ( contract, signer, signature, params, error = null ) {
	if ( error ) {
		await expect(
			contract.connect( signer ).functions[ signature ]( params[ 0 ], params[ 1 ], params[ 2 ], params[ 3 ], params[ 4 ], params[ 5 ], params[ 6 ], params[ 7 ], params[ 8 ], params[ 9 ] )
		)?.to.be.revertedWith( error )
	}
	else {
		await expect(
