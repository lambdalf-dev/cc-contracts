...
*/
contract Mock_ERC721BatchStakable is ERC721BatchStakable {
	...
	function mintAndStake( uint256 qty_, uint256 qtyStaked_ ) public {
		_mintAndStake( _msgSender(), qty_, qtyStaked_ );
	}
